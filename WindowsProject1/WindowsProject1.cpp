            ...
            for (int g = 0; g < circles.x.size(); g++)
            {
                if (y > circles.y[g] and y < circles.y[g] + 50)
                {
                    ...
                    bool pod_spodem = 0;
                        ...
                        if (picked_up == 0 and circles.masa[g]<100 and pod_spodem == 0)
                        {
                            pickme = g;
                            picked_up = 1;
                            shape = 'c';
            ...
            for (int g = 0; g < boxes.x.size(); g++)
            {
                if (y > boxes.y[g] and y < boxes.y[g] + 50)
                {
                    if (x >= boxes.x[g] and x <= boxes.x[g] + 50)
                    {
                        ...
                        if (picked_up == 0 and boxes.masa[g] < 100 and pod_spodem == 0)
                        {
                            pickme = g;
                            picked_up = 1;
                            shape = 's';
            ...
            for (int g = 0; g < triangles.x.size(); g++)
            {
                if (y > triangles.y[g] and y < triangles.y[g] + 50)
                {
                    ...
                    bool pod_spodem = 0;
                        ...
                        if (picked_up == 0 and triangles.masa[g] < 100 and pod_spodem == 0)
                        {
                            pickme = g;
                            picked_up = 1;
                            shape = 't';
